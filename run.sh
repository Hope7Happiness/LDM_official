...
CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 python main.py --base configs/latent-diffusion/ffhq-ldm-vq-4.yaml -t --gpus 0,1,2,3,4,5,6 --resume logs/2025-03-26T05-14-20_ffhq-ldm-vq-4 \
	2>&1 | tee main.log
